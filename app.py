...
languages_list = ["Telugu" ,"German", "French", "Hindi", "Romanian", "Spanish", "Japanese","Korean", "Italian", "Portuguese", "Russian", "Arabic", "Dutch", "Greek","Turkish", "Polish", "Swedish", "Finnish", "Norwegian", "Danish"]

# demo = gr.Interface(fn=summary, inputs="text",outputs="text")
demo = gr.Interface(fn=translate_text,
                    inputs=[gr.Textbox(label="Input text to translate",lines=6), gr.Dropdown(languages_list, label="Select Destination Languages")],
